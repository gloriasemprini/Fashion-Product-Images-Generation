        ...
        for e in range(1, epoch_count + 1):
            ...
            for i in range(iteration_count):
                ...
                for _ in range(10): 
                    ...
                    generated_images = generator.predict(gan_batch_x, verbose=0)
            ...
            if plt_frq is not None and e % 3 == 0:  # Calcola ogni 5 epoche (puoi regolare questa frequenza)
                ...
                print(f"Inception Score at epoch {e}: {inception_score:.4f}")
            ...
            if plt_frq is not None and e % plt_frq == 0:
                ...
                print("Calculating Inception Score...")
                inception_score = calculate_inception_score(generated_output)
                print(f"Inception Score at epoch {e}: {inception_score:.4f}")
